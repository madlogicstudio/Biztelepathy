...
export const Chatbot = () => {
    ...
    const chatBotBubbles = [
        "Hi! I'm Biz, the Biztelepathy chatbot.",
        "Need some help? Just click me!",
        "I'm here if you need anything.",
        "Got a question? Biz is here to help!",
        "Need help navigating Biztelepathy?",
            ...
            {openChatbot && <div className="sm:h-auto h-[100dvh] sm:w-[480px] w-full fixed sm:top-6 top-0 sm:right-3 right-0 
                ...
                <div className="w-full flex flex-row items-center p-3 bg-[var(--background)] rounded-t-lg">
                    ...
                    <div className="w-full flex flex-row items-center gap-3">
                        ...
                        <Image src="/images/Bee.png" height={52} width={52} alt=""  />

                        <div className="flex flex-col">

                            <span className="font-sans text-md font-semibold text-[var(--primary)]">BizBot</span>
                ...
                <div className="sm:h-full min-h-[85vh] w-full bg-gray-700 flex flex-col rounded-b-lg">
                        ...
                        {messages.map((msg, index) => (
                            <div
                                ...
                                className={`max-w-[80%] rounded-xl px-4 py-2 text-sm ${
                                    msg.role === "user"
                                        ? "ml-auto bg-[var(--background)] dark:bg-[var(--foreground)] text-white"
                    ...
                    <div className="flex flex-row items-center bg-white p-2">
                        ...
                        <input
                            type="text"
                            placeholder="Ask about Biztelepathy..."
                            value={message}
                        ...
                        <div className="ml-auto bg-[var(--secondary)] rounded-full cursor-pointer p-3">

                            <SendHorizonal className=" text-black h-5 w-5" 
                                onClick={() => sendMessage()} />
