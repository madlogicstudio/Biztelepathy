...
export const HiveCard = ({isActive, image, title, text, cardId, onClick, cardRef}: HiveCardProps) => {
    ...
    return (
        <div ref={cardRef} className="hexagon flex flex-col items-center justify-center sm:gap-2 gap-1 p-4 cursor-pointer text-center sm:h-[280px] md:[180] h-[180px] z-0"
            onClick={onClick}>
