            ...
            <div className="max-w-[1280px] w-full flex sm:flex-row flex-col items-start justify-start gap-12 py-20 flex-wrap">
                ...
                <div className="flex-2 flex flex-col items-start justify-start gap-3">
                    ...
                    <div className="flex flex-col items-start justify-start gap-3">
                        <span className="font-sans text-md text-gray-400">Get product updates and news from Biztelepathy.</span>
                        <input type="email" name="" placeholder="Your email" className="sm:w-[320px] bg-[var(--dark)] w-full outline-none border border-gray-600 rounded-lg p-2 sm:text-md text-sm" />
